...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden'>
      ...
      flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkHover dark:shadow-white/20" : "" } `}>
        <a href="#">
        ...
        z-50 h-screen bg-irides4 transition duration-500 text-xl dark:bg-darkHover dark:text-white'>
