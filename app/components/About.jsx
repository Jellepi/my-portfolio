    ...
    >
      ...
      <motion.h2 className='text-center text-5xl'
        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            <Image src={assets.user_image} alt='userPic' 
            ...
            className="my-6 text-gray-700 font-Ovo font-semibold dark:text-white/80">Tools I use</motion.h4>
                <motion.ul className="flex items-center gap-2 sm:gap-5"
                  initial={{ pacity: 0}}
                  whileInView={{opacity: 1}}
                ...
                >
                    ...
                    className='flex items-center justify-center w-12 sm:w-14 aspect-square cursor-pointer hover:-translate-y-1 duration-500'
                     key={index}>
                        <Image src={tool} alt="Tool" className="w-10 mt-5" />
                    </motion.li>
                        ))}
                </motion.ul>
            </motion.div>
